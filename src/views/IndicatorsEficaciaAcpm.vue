  ...
  <div class="indicators">
    ...
    <section class="indicator-info">
      ...
      <table class="info-table">
        ...
        <tbody>
          <tr>
            <td class="indicator-name">Eficacia de las ACPM</td>
            <td>Estratégico</td>
            <td class="formula">
              (# Total ACPM cerradas eficazmente / # Total ACPM cerradas) × 100
            </td>
    ...
    <div class="indicadores-grid">
          ...
          <table class="results-table">
            <thead>
              <tr>
                ...
                <th class="col-num"># Total ACPM cerradas eficazmente</th>
                <th class="col-num"># Total ACPM cerradas</th>
                <th class="col-pct">Eficacia de las ACPM</th>
                ...
                <th class="col-num"># Total ACPM con cierre programado</th>
                <th class="col-num"># Total ACPM con cierre programado vencido</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div class="indicadores-col-graficas">
              ...
              <div class="simple-bar-chart__body">
                ...
                <div class="simple-bars-area">
                  <div v-for="mes in mesesResultados" :key="mes.numero" class="simple-bar-group">
                    ...
                    <div class="simple-bar simple-bar-eficaz" style="height: 0%; width: 28px;"></div>
                    <span class="simple-bar-label">{{ mes.nombreCorto }}</span>
                  </div>
                </div>
              </div>
              <div class="simple-legend simple-legend-bottom">
                <div class="legend-item"><span class="legend-bar legend-bar-total"></span> Total ACPM cerradas</div>
                <div class="legend-item"><span class="legend-bar legend-bar-eficaz"></span> Cerradas eficazmente</div>
              </div>
            </section>
          </div>
        </section>
        ...
        <section class="indicador-torta-card">
          ...
          <p class="indicador-torta-desc">Promedio de eficacia del periodo filtrado.</p>
          ...
          <form @submit.prevent="guardarAnalisis" class="form-analisis">
            <div class="form-row">
              <div class="form-group">
                <label for="mes-analisis-ef">Mes *</label>
                <select id="mes-analisis-ef" v-model="formAnalisis.mes" required :disabled="!!analisisEditando" class="form-select">
            ...
            <div class="form-group">
              <label for="analisis-ef">Análisis (Causas Principales) *</label>
              <textarea id="analisis-ef" v-model="formAnalisis.analisis" placeholder="Identifique dónde se generan las desviaciones y su pareto..." rows="4" required class="form-textarea"></textarea>
            </div>
            <div class="form-group">
              <label for="acciones-ef">Acciones a Tomar Frente al Análisis *</label>
              <textarea id="acciones-ef" v-model="formAnalisis.acciones" placeholder="Liste las acciones con las que se van a eliminar/controlar las causas..." rows="4" required class="form-textarea"></textarea>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label for="responsable-ef">Responsable (Nombre-Cargo) *</label>
                <input type="text" id="responsable-ef" v-model="formAnalisis.responsable" placeholder="Ej: Juan Pérez - Coordinador TIC" required class="form-input" />
              </div>
              <div class="form-group">
                <label for="fecha-ef">Fecha de Compromiso *</label>
                <input type="date" id="fecha-ef" v-model="formAnalisis.fecha_compromiso" required class="form-input" />
              </div>
            </div>
            <div class="form-group">
              <label for="seguimiento-ef">Seguimiento *</label>
              <textarea id="seguimiento-ef" v-model="formAnalisis.seguimiento" placeholder="Relacione el estado de cumplimiento de las acciones definidas..." rows="3" required class="form-textarea"></textarea>
            </div>
          </form>
        </div>
...
.results-table .col-num  { width: 130px; min-width: 100px; }
.results-table .col-pct  { width: 110px; min-width: 90px; }
...
.simple-bar-eficaz{ background: #22c55e; }
.simple-bar-label {
  position: absolute;
  bottom: -20px;
  left: 50%;
...
.legend-bar-eficaz{ background: #22c55e; }
